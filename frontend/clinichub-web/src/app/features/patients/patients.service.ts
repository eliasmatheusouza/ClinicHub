...
import { PagedResult, Patient } from '../../core/models/clinic.models';
...
export class PatientsService {
  ...
  list(term: string, page: number, pageSize: number): Observable<PagedResult<Patient>> {
    const params = new HttpParams().set('term', term).set('page', page).set('pageSize', pageSize);
    return this.api.get<PagedResult<Patient>>('/patients', params);
  }
